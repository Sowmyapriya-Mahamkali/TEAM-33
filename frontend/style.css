...
/* TEAM-33 Frontend - Styles */

:root {
    /* Colors - mapped to design system */
    --color-primary: var(--color-teal-500);
    --color-primary-dark: var(--color-teal-600);
    --color-primary-light: rgba(var(--color-teal-500-rgb), 0.15);
    ...
    /* Neutrals - mapped to design system */
    --color-bg-primary: var(--color-surface);
    --color-bg-secondary: var(--color-background);
    --color-bg-tertiary: var(--color-secondary);
    --color-text-primary: var(--color-text);
    --color-text-secondary: var(--color-text-secondary);
    --color-border: var(--color-border);
    
    /* Spacing - mapped to design system */
    ...
    --font-size-xl: var(--font-size-2xl);
    --font-size-2xl: var(--font-size-3xl);
    
    /* Border Radius - mapped to design system */
    ...
    /* Transitions - mapped to design system */
...
.spinner {
    ...
    border-top-color: var(--color-cream-50);
    border-radius: 50%;
